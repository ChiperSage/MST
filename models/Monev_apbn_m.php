...
class Monev_apbn_m extends CI_Model{
    ...
    public function get_total()
    {
      ...
      WHERE r.sumber_dana = 'APBN' AND ( (t.status_lelang = 0 AND t.paket_status = 0 AND t.ukpbj = '1106.00')
    ...
    -- ( left(r.akhir_pengadaan,4) = '$tahun' OR left(r.awal_pekerjaan,4) = '$tahun' )
     ...
     AND r.sumber_dana = 'APBN' AND pk.paket_status = 2) as tsp,
      ...
      -- LEFT JOIN tb_lelang l ON r.kode_rup = l.kode_rup
      -- LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      -- WHERE (l.tahun LIKE '%$tahun%' OR t.tahun LIKE '%$tahun%' AND r.sumber_dana = 'APBN')  AND r.id_satker = a.kode AND r.jenis_pengadaan LIKE '%pekerjaan konstruksi%') as b_kt,
    ...
    public function get_laporan()
    {
      ...
      -- LEFT JOIN tb_lelang l ON r.kode_rup = l.kode_rup
      -- LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      -- WHERE (l.tahun LIKE '%$tahun%' OR t.tahun LIKE '%$tahun%' AND r.sumber_dana = 'APBN') AND r.id_satker = a.kode AND r.jenis_pengadaan LIKE '%jasa konsultansi%') as b_ks,
      --
      -- (SELECT COUNT(r.kode_rup) FROM tb_rup r
      -- INNER JOIN tb_batal b ON r.kode_rup = b.batal_paket
      -- LEFT JOIN tb_lelang l ON r.kode_rup = l.kode_rup
      -- LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      -- WHERE (l.tahun LIKE '%$tahun%' OR t.tahun LIKE '%$tahun%' AND r.sumber_dana = 'APBN') AND r.id_satker = a.kode AND r.jenis_pengadaan LIKE '%barang%') as b_b,
      --
      -- (SELECT COUNT(r.kode_rup) FROM tb_rup r
      -- INNER JOIN tb_batal b ON r.kode_rup = b.batal_paket
      -- LEFT JOIN tb_lelang l ON r.kode_rup = l.kode_rup
      -- LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      -- WHERE (l.tahun LIKE '%$tahun%' OR t.tahun LIKE '%$tahun%' AND r.sumber_dana = 'APBN') AND r.id_satker = a.kode AND r.jenis_pengadaan LIKE '%jasa lainnya%') as b_j
