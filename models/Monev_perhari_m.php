...
class Monev_perhari_m extends CI_Model{
    ...
    public function get_laporan()
    {
      ...
      (SELECT COUNT(v.kode_rup) FROM tb_review v
      -- LEFT JOIN tb_lelang l ON v.kode_rup = l.kode_rup
	    LEFT JOIN tb_rup r ON v.kode_rup = r.kode_rup
    ...
    public function get_format_wa_total()
    {
      ...
      (SELECT COUNT(l.kode_rup) FROM tb_rup r
      LEFT JOIN tb_lelang l ON r.kode_rup = l.kode_rup
      WHERE (l.tahun LIKE '%$tahun%' AND l.status_lelang = 0 AND l.ukpbj = '1106.00' AND r.sumber_dana != 'APBN')) as total_bt,

      (SELECT COUNT(l.kode_rup) FROM tb_rup r
      LEFT JOIN tb_lelang_bck l ON r.kode_rup = l.kode_rup
      WHERE (l.tahun LIKE '%$tahun%' AND l.status_lelang = 0 AND l.ukpbj = '1106.00' AND r.sumber_dana != 'APBN')) as total_selisih_bt,

      -- Total Tayang & selisih

      (SELECT COUNT(l.kode_rup) FROM tb_rup r
      LEFT JOIN tb_lelang l ON r.kode_rup = l.kode_rup
      WHERE ((l.tahun LIKE '%$tahun%' AND l.status_lelang = 1 AND l.menang = 0 AND r.sumber_dana != 'APBN') )) as total_tayang,

      (SELECT COUNT(l.kode_rup) FROM tb_rup r
      LEFT JOIN tb_lelang_bck l ON r.kode_rup = l.kode_rup
      WHERE ((l.tahun LIKE '%$tahun%' AND l.status_lelang = 1 AND l.menang = 0 AND r.sumber_dana != 'APBN') )) as total_selisih_tayang,
    ...
    public function get_format_wa_laporan()
    {
      ...
      WHERE r.id_satker = a.kode AND r.sumber_dana != 'APBN'
      AND ((l.tahun LIKE '%$tahun%' AND l.status_lelang = 0 AND l.ukpbj = '1106.00')
      OR (t.tahun LIKE '%$tahun%' AND t.status_lelang = 0 AND t.ukpbj = '1106.00')) ) as bt_selisih,
      ...
      // AND (c.status_lelang = 1 AND c.paket_status = 1 AND c.ukpbj is null AND b.sumber_dana != 'APBN')
      // OR (c.status_lelang = 0 AND c.ukpbj = '1106.00' AND b.sumber_dana != 'APBN')
      // OR (c.status_lelang = 0 AND c.paket_status = 0 AND c.ukpbj = '1106.00' AND b.sumber_dana != 'APBN')
      // OR (c.status_lelang = 1 AND c.paket_status = 1 AND c.ukpbj = '1106.00' AND b.sumber_dana != 'APBN')
      // OR (d.tahun LIKE '%$tahun%' AND b.sumber_dana != 'APBN')
      // OR (d.status_lelang = 0 AND d.paket_status = 0 AND d.ukpbj = '1106.00' AND b.sumber_dana != 'APBN')
      // OR (d.status_lelang = 1 AND d.paket_status = 1 AND d.ukpbj = '1106.00' AND b.sumber_dana != 'APBN') )
      // GROUP BY a.kode
      // ORDER BY a.singkatan ASC
