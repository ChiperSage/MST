  						...
  						<li class="dropdown user user-menu">
  							...
  							<ul class="dropdown-menu">
  								...
  								<li class="user-footer">
  									<div class="pull-left">
  										<a href="<?php echo base_url('profile/edit_user/'.$this->session->userdata('user_id')) ?>" class="btn btn-default btn-flat">Edit Profile</a>
  									</div>
...
<?php $this->load->view('admin/menu_all') ?>
