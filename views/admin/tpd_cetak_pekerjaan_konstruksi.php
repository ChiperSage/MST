...
<table class="table table-sm table-bordered">
  ...
  <tr>
    ...
    <td class="text-center"><?php echo ($tpd->harga_perkiraan_spse == 1) ? '<i class="fa fa-check"></i>' : '' ; ?></td>
  </tr>
  <tr>
    <td></td>
    <td>a. Daftar Kuantitas dan Harga</td>
    <td></td>
  ...
  <tr>
    <td></td>
    <td>a. Analisa Harga Satuan</td>
    <td></td>
    <td class="text-center"><?php echo ($tpd->analisa_harga == 1) ? '<i class="fa fa-check"></i>' : '' ; ?></td>
    <td class="text-center"><?php echo ($tpd->analisa_harga_spse == 1) ? '<i class="fa fa-check"></i>' : '' ; ?></td>
  </tr>
  <tr>
    <td></td>
    <td>b. Daftar Upah, bahan dan peralatan</td>
    ...
    <td class="text-center"><?php echo ($tpd->daftar_upah_spse == 1) ? '<i class="fa fa-check"></i>' : '' ; ?></td>
  </tr>
  <tr>
    <td></td>
  ...
  <tr>
    <td></td>
    <td>b. Jangka Waktu Pelaksanaan Pekerjaan</td>
    <td></td>
    <td class="text-center"><?php echo ($tpd->jangka_waktu == 1) ? '<i class="fa fa-check"></i>' : '' ; ?></td>
    <td class="text-center"><?php echo ($tpd->jangka_waktu_spse == 1) ? '<i class="fa fa-check"></i>' : '' ; ?></td>
  </tr>
  <tr>
    <td></td>
    <td>c. Daftar Kebutuhan Tenaga Ahli</td>
    <td></td>
  ...
  <tr>
    <td></td>
    <td>d. Daftar Peralatan Utama</td>
    <td></td>
  ...
  <tr>
    <td></td>
    <td>a. Naskah Rencana Kontrak (ditandatangani KPA/PPK)</td>
    <td></td>
