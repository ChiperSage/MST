    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">SKN</h3>
				<a class="btn btn-primary btn-sm pull-right" href="<?php echo base_url('skn/create') ?>"><i class="fa fa-plus-circle"></i> Tambah</a>
			</div>
      <!-- /.box-header -->
      <div class="box-body">
						...
						<?php $i=0; foreach ($skn as $value) { $i++ ?>
							<tr>
								...
								<td>
									...
									if($value->skn < 0){ ?>
									<a class="btn btn-sm btn-danger" href="<?php echo base_url('skn/delete/'.$value->id) ?>" onClick="return confirm('Hapus data ini?')"><i class="fa fa-trash"></i> Hapus</a>
								  <?php } ?>
								</td>
							</tr>
						<?php } ?>
