...
<table class="table table-sm table-bordered">
  ...
  <tr>
    <td></td>
    <td>b. Tabel Biaya Langsung Personil (billing rate)</td>
    <td></td>
    <td class="text-center"><?php echo ($tpd->tabel_biaya == 1) ? '<i class="fa fa-check"></i>' : '' ; ?></td>
    <td></td>
  </tr>
  <tr>
    <td></td>
  ...
  <tr>
    <td></td>
    <td>c. Daftar Kebutuhan Personil (Tenaga Ahli) dan Kualifikasi</td>
    <td></td>
