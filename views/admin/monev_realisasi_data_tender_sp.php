    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
				...
				<ul class="dropdown-menu" role="menu">
					<li><a target="_blank" href="<?php echo base_url() ?>monev/realisasi_data_tender_sp/?type=pdf">PDF 1</a></li>
					<li><a target="_blank" href="<?php echo base_url() ?>monev/realisasi_data_tender_sp/?type=pdf2">PDF 2</a></li>
					<li><a target="_blank" href="<?php echo base_url() ?>monev/realisasi_data_tender_sp/?type=image">Image 1</a></li>
					<li><a target="_blank" href="<?php echo base_url() ?>monev/realisasi_data_tender_sp/?type=image2">Image 2</a></li>
				</ul>
				</div>
				<br>
					...
					<tbody>
						...
						<?php $i=0; foreach ($lap as $value) { $i++ ?>
							<tr>
								...
								<td class="text-center"><a href="#" onClick="detail_paket(this)" data-id="<?php echo $value->kode ?>-sp_belum_tayang-pekerjaan_konstruksi" data-toggle="modal" data-target="#modal-default"><?php echo $value->sp_bt_kt ?></a></td>
								<td class="text-center"><a href="#" onClick="detail_paket(this)" data-id="<?php echo $value->kode ?>-sp_belum_tayang-jasa_konsultansi" data-toggle="modal" data-target="#modal-default"><?php echo $value->sp_bt_ks ?></a></td>
								<td class="text-center"><a href="#" onClick="detail_paket(this)" data-id="<?php echo $value->kode ?>-sp_belum_tayang-barang" data-toggle="modal" data-target="#modal-default"><?php echo $value->sp_bt_b ?></a></td>
								<td class="text-center"><a href="#" onClick="detail_paket(this)" data-id="<?php echo $value->kode ?>-sp_belum_tayang-jasa_lainnya" data-toggle="modal" data-target="#modal-default"><?php echo $value->sp_bt_j ?></a></td>
