...
<td></td>
	...
	<td><input type="checkbox" id="harga_perkiraan_spse-<?php echo $detail->harga_perkiraan_spse ?>" <?php echo ($detail->harga_perkiraan_spse == 1) ? 'checked' : '' ; ?> onChange="update_berkas(this.id)"></td>
	</tr>
	<tr>
	...
	<td><input type="checkbox" id="analisa_harga-<?php echo $detail->analisa_harga ?>" <?php echo ($detail->analisa_harga == 1) ? 'checked' : '' ; ?> onChange="update_berkas(this.id)"></td>
	<td><input type="checkbox" id="analisa_harga_spse-<?php echo $detail->analisa_harga_spse ?>" <?php echo ($detail->analisa_harga_spse == 1) ? 'checked' : '' ; ?> onChange="update_berkas(this.id)"></td>
	</tr>
	<tr>
	<td>Nilai Pagu</td>
	<td><?php echo 'Rp. '.number_format($detail->nilai_pagu) ?></td>
	<td>- Daftar upah, bahan dan peralatan</td>
	<td><input type="checkbox" id="daftar_upah-<?php echo $detail->daftar_upah ?>" <?php echo ($detail->daftar_upah == 1) ? 'checked' : '' ; ?> onChange="update_berkas(this.id)"></td>
	<td><input type="checkbox" id="daftar_upah_spse-<?php echo $detail->daftar_upah_spse ?>" <?php echo ($detail->daftar_upah_spse == 1) ? 'checked' : '' ; ?> onChange="update_berkas(this.id)"></td>
	</tr>
	<tr>
...
<td></td>
	...
	<td>6. Kerangka Acuan Kerja (KAK)</td>
	<td></td>
<td></td>
	</tr>
	<tr>
	...
	<td></td>
	<td></td>
	<td>- Jangka waktu pelaksaan pekerjaan</td>
	...
	<td>- Hari Kalender</td>
	<td>
		<input type="text" size="5" id="hari_kalender-<?php echo $detail->hari_kalender ?>" value="<?php echo $detail->hari_kalender ?>" onChange="update_berkas('hari_kalender-' + this.value)">
		<!-- <input type="checkbox" id="hari_kalender-<?php echo $detail->hari_kalender ?>" onChange="update_berkas(this.id)"> -->
	</td>
<td></td>
	</tr>
	<tr>
	<td></td>
	<td></td>
	<td>- Daftar kebutuhan Tenaga Ahli</td>
	<td><input type="checkbox" id="daftar_kebutuhan-<?php echo $detail->daftar_kebutuhan ?>" <?php echo ($detail->daftar_kebutuhan == 1) ? 'checked' : '' ; ?> onChange="update_berkas(this.id)"></td>
	<td><input type="checkbox" id="daftar_kebutuhan_spse-<?php echo $detail->daftar_kebutuhan_spse ?>" <?php echo ($detail->daftar_kebutuhan_spse == 1) ? 'checked' : '' ; ?> onChange="update_berkas(this.id)"></td>
	</tr>
	<tr>
	<td></td>
	<td></td>
	<td>- Daftar peralatan utama</td>
	<td><input type="checkbox" id="daftar_peralatan-<?php echo $detail->daftar_peralatan ?>" <?php echo ($detail->daftar_peralatan == 1) ? 'checked' : '' ; ?> onChange="update_berkas(this.id)"></td>
	<td><input type="checkbox" id="daftar_peralatan_spse-<?php echo $detail->daftar_peralatan_spse ?>" <?php echo ($detail->daftar_peralatan_spse == 1) ? 'checked' : '' ; ?> onChange="update_berkas(this.id)"></td>
	</tr>
	<tr>
	<td></td>
	<td></td>
