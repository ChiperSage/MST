...
<div class="content-wrapper">
 <!-- Content Header (Page header) -->
	<section class="content-header">
		...
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url('admin') ?>"><i class="fa fa-dashboard"></i> Kabag PP</a></li>
		...
		<div class="box box-info">
		  <div class="box-header with-border">
		    <h3 class="box-title">Data Anggota <?php echo isset($sp->sp_kelompok) ? $sp->sp_kelompok : '' ; ?></h3>
				<a class="btn btn-default btn-sm pull-right" href="<?php echo base_url('kabagpp/sp') ?>"><i class="fa fa-back"></i> Kembali</a>
		  </div>
		  <!-- /.box-header -->
		  <!-- form start -->
