...
<div id="html-content-holder" class="table-responsive" style="background-color: #FFF; padding: 20px;">
    ...
    <tbody>
      ...
      <?php $i=0; foreach ($lap as $value) { $i++ ?>
        <tr style="white-space:nowrap;">
          ...
          ?>
          <td class="text-center"><?php echo $result1 . $value->t_kt ?></td>
          <td class="text-center"><?php echo $result2 . $value->t_ks ?></td>
          <td class="text-center"><?php echo $result3 . $value->t_b ?></td>
          <td class="text-center"><?php echo $result4 . $value->t_j ?></td>
