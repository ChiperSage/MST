	...
	<section class="content">
		...
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title text-capitalize">daftar paket telah sp belum tayang<?php echo str_replace('_',' ',$this->uri->segment(3)) ?></h3>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
...
<ul class="dropdown-menu" role="menu">
	<li><a target="_blank" href="<?php echo base_url() ?>monev/daftar_paket_sp_bt/<?php echo $var.'?jenis_pengadaan='.$jenis.'&type=excel'; ?>">Excel</a></li>
