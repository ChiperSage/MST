...
<tbody>
	...
	<td>- Tabel Biaya Langsung Personil (Billing Rate)</td>
	<td><input type="checkbox" id="tabel_biaya-<?php echo $detail->tabel_biaya ?>" <?php echo ($detail->tabel_biaya == 1) ? 'checked' : '' ; ?> onChange="update_berkas(this.id)"></td>
	<td></td>
	</tr>
	<tr>
	<td>Sumber Dana</td>
	...
	<td></td>
	<td>- Hari Kalender</td>
	<td><input type="text" size="5" id="hari_kalender-<?php echo $detail->hari_kalender ?>" value="<?php echo $detail->hari_kalender ?>" onChange="update_berkas('hari_kalender-' + this.value)"></td>
	<td></td>
	</tr>
	<tr>
	<td></td>
	<td></td>
	<td>- Daftar Kebutuhan Personil (Tenaga Ahli) dan Kualifikasi</td>
