...
<div class="content-wrapper">
 <!-- Content Header (Page header) -->
	<section class="content-header">
		...
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url('admin') ?>"><i class="fa fa-dashboard"></i> Money</a></li>
      <li>History</li>
		</ol>
	</section>
		...
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<ul class="dropdown-menu" role="menu">
					<li><a target="_blank" href="<?php echo base_url() ?>monev/history_review?type=pdf">PDF 1</a></li>
					<li><a target="_blank" href="<?php echo base_url() ?>monev/history_review?type=pdf2">PDF 2</a></li>
				</ul>
				</div>
				</p>
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td <?php echo (empty($value->nama_kpa)) ? 'style="color:#FFF; opacity:0.1;"' : '' ; ?>><?php echo $value->kode_rup ?></td>
				        <td <?php echo (empty($value->nama_kpa)) ? 'style="color:#FFF; opacity:0.1;"' : '' ; ?>><?php echo $value->nama_paket ?></td>
				        <td <?php echo (empty($value->nama_kpa)) ? 'style="color:#FFF; opacity:0.1;"' : '' ; ?>><?php echo $value->nama_satker ?></td>
